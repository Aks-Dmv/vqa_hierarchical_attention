...
if __name__ == "__main__":
    ...
    parser.add_argument('--train_question_path', type=str, default='data/OpenEnded_mscoco_train2014_questions.json')
    ...
    parser.add_argument('--test_annotation_path', type=str, default='data/mscoco_val2014_annotations.json')
    ...
    print(args.train_question_path)
    print("logging", args.log_validation)
    ...
    torch.save(experiment_runner._model.state_dict(), args.model + "_model_final.pt")
